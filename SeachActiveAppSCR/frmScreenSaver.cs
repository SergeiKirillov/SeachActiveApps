...
namespace SeachActiveAppSCR
{
    public partial class frmScreenSaver : Form
    {
        ...
        private void MoveTimer_Tick(object sender, EventArgs e)
        {
            ...
            //Если отключение заставки не активировано от выводим надпись null
            if (Program.blDisableScreenSave)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine(ex.Message);
                    lblStopTimeScreenSaver.Text = "null";
                }
            ...
            {
                lblStopTimeScreenSaver.Text = "Не отключаем заставку";
            }
